...
<section id="first_sec" class="sec first_sec">
    ...
    <aside class="clearfix anim1 hidden">
        <span class="slogan"><?php _e('Engineering Consultancy'); ?></span>
        <div class="social">
...
<section id="fourth_sec" class="sec fourth_sec">
    ...
    <div class="max_w">
        <div class="flex flex--middle clients_list stagger_4">
            <div class="col col--6 col__md--2 col__lg--2">
                <a href="#">
                    <svg class="transition" viewBox="0 0 241.9 36">
            ...
            <div class="col col--6 col__md--2 col__lg--2">
                <a href="#">
                    <svg class="transition" viewBox="0 0 141.5 62.6">
