...
<head>
    ...
    ?>
        ...
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/style_ar.css">
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/contact_form_ar.css">
    <?php
    }else{
    ?>
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/style_en.css">
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/contact_form_en.css">
    <?php
    }
    ?>
...
<header class="navbar-fixed-top transition hidden">
    <span class="horiz_logo transition">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_horizontal_<?php echo (get_locale() == 'ar') ? 'ar' : 'en' ?>.png" />
    </span>
    ...
    <nav class="pushy pushy-left">
        ...
        <div class="social">
            ...
            <a href="<?php echo $GLOBALS['cgv']['twitter'] ?>" class="twitter" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
